...
contract MerkleClaim {
    ...
    /// @notice WINE token to claim
    IWine public immutable WINE;
    ...
    constructor(address _wine, bytes32 _merkleRoot) {
        WINE = IWine(_wine);
    ...
    function claim(
        ...
        require(WINE.claim(to, amount), "CLAIM_FAILED");
